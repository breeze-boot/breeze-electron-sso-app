...
import { SettingState } from '@renderer/store/modules/types/types.ts'
import setting from '@renderer/setting.ts'
import { MenuLayout, Settings, Theme } from '@renderer/types/types.ts'
import { CookiesKey, CookiesStorage } from '@renderer/utils/cookies.ts'
import { DEVICE, LAYOUT } from '@renderer/utils/common.ts'
...
const useSettingStore: StoreDefinition<'SettingStore', SettingState> = defineStore(
  'SettingStore',
  () => {
    // 响应式状态
